...
import { Mail, Lock, Eye, EyeOff, AlertCircle, Loader2, Sparkles, Github, User } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        ...
        <p className="text-muted-foreground mt-2">Get started with Boost today</p>
      </div>
